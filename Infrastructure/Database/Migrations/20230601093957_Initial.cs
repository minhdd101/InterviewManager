        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JoinStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    JoinEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interviews_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Benifit = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    ExpFrom = table.Column<short>(type: "smallint", nullable: false),
                    ExpTo = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recruitments_Department_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Department",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recruitments_Position_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResolveProblem = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Attridutes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SelflLearning = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applicants_Recruitments_RecruitmentId",
